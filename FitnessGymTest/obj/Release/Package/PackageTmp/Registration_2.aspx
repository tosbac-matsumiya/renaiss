<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Registration_2.aspx.vb" Inherits="FitnessGymTest.Registration_2" %>
...
-->
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <%--<img src="#" class="img-responsive"/>--%><%--会員証イメージ画像--%>                            <%--<img src="#" class="photo-crop-preview2"/>d2017/08/03_TOS163--%>
           ...
           　 <div class="form-group">
            ...
            <div class="button-group">
                <asp:Button ID="BtnNext" runat="server" Text="STEP 3　登録内容確認へ" CssClass="btn2 edit-btn" />
            </div>

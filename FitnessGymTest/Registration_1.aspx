<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Registration_1.aspx.vb" Inherits="FitnessGymTest.Registration_1" %>
            ...
            <div id="JSOK" class="backcolor_w" style="display:none;">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-10 col-sm-offset-1">
                            ...
                            <asp:DataList ID="dltPlan" runat="server" DataKeyField="商品ＣＤ" DataSourceID="SqlDataSource2" CssClass="image_list" Visible="false">
                                <ItemTemplate>
                                    <div class="image_box">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-sm-offset-1">
                            <asp:Panel ID="pnlDatepicker" runat="server" Visible="false">
                ...
                <div class="button-group" style="margin-top: 30px;">
                    <asp:Button ID="btnNext" runat="server" Text="STEP 2　お客様情報入力へ" CssClass="btn2 edit-btn" />
                    <br />
